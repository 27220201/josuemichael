...
print("los diez idiomas mas hablados :")
...
def most_spoken_languages():
    ...
    return sorted(languages, key=lambda x: x[1], reverse=True)[:10]
...
#3) Ejercicio Complejo: Generador de Contraseñas Seguras Descripción: Vamos a crear un generador de contraseñas seguras utilizando los conceptos que hemos aprendido hasta ahora, incluyendo funciones, módulos y control de flujo. La idea es que el programa genere una contraseña aleatoria con una longitud específica y asegure que cumple con ciertos requisitos de seguridad.
...
print("Hola python contrasela segura")
contraseña = input("favor de ingresar su contraseña: ")

if len(contraseña) < 8:
    print("Contraseña muy corta, debe contener mas de 8 caracteres.")
else:
    minuscula = False
    for minus in contraseña:
        if minus.islower()==True:
            minuscula = True
    if not minuscula:
        print("La contraseña debe contener almenos una minuscula.")
    mayusculas = False
    for mayus in contraseña:
        if mayus.isupper()==True:
            mayusculas = True
    if not mayusculas:
        print("La contraseña debe contener almenos una mayuscula.")
